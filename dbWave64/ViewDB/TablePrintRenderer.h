...
public:
	...
	virtual void render_for_export(ViewDbTable* view, CDC* p_dc) = 0;
};
...
public:
	...
	void begin_printing(ViewDbTable*, CDC*, CPrintInfo*) override {}
	void print_page(ViewDbTable* view, CDC* p_dc, CPrintInfo* p_info) override;
	void end_printing(ViewDbTable*, CDC*, CPrintInfo*) override {}
	void render_for_export(ViewDbTable* , CDC* ) override {}
};
