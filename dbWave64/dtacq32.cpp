...
{
	CString result;
	GetProperty(0x26, VT_BSTR, &result);
	return result;
}
...
{
	CString result;
	GetProperty(DISPID_CAPTION, VT_BSTR, &result);
	return result;
}
...
{
	CString result;
	GetProperty(0x29, VT_BSTR, &result);
	return result;
}
...
{
	CString result;
	GetProperty(0x2a, VT_BSTR, &result);
	return result;
}
...
long CDTAcq32::GetSingleValue(long uiChannel, double dGain)
{
	...
	static BYTE parms[] =
		VTS_I4 VTS_R8;
	InvokeHelper(0x34, DISPATCH_METHOD, VT_I4, &result, parms,
	             uiChannel, dGain);
	return result;
}
...
{
	long result;
	InvokeHelper(0x35, DISPATCH_METHOD, VT_I4, &result, nullptr);
	return result;
}
...
short CDTAcq32::GetDevCaps(short olDc)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x3c, DISPATCH_METHOD, VT_I2, &result, parms,
	             olDc);
	return result;
}
...
long CDTAcq32::GetSSCaps(short OlSSc)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x3d, DISPATCH_METHOD, VT_I4, &result, parms,
	             OlSSc);
	return result;
}
...
double CDTAcq32::GetSSCapsEx(short OlSSc)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x3e, DISPATCH_METHOD, VT_R8, &result, parms,
	             OlSSc);
	return result;
}
...
short CDTAcq32::GetChannelList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x3f, DISPATCH_PROPERTYGET, VT_I2, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetGainList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x40, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetFilterList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x41, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
short CDTAcq32::GetResolutionValues(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x42, DISPATCH_PROPERTYGET, VT_I2, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetMinRangeValues(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x43, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetMaxRangeValues(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x44, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetGainValues(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x45, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
double CDTAcq32::GetFilterValues(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x46, DISPATCH_PROPERTYGET, VT_R8, &result, parms,
	             index);
	return result;
}
...
BOOL CDTAcq32::GetInhibitList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x47, DISPATCH_PROPERTYGET, VT_BOOL, &result, parms,
	             index);
	return result;
}
...
long CDTAcq32::GetDIOList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x48, DISPATCH_PROPERTYGET, VT_I4, &result, parms,
	             index);
	return result;
}
...
CString CDTAcq32::GetSubSystemList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x49, DISPATCH_PROPERTYGET, VT_BSTR, &result, parms,
	             index);
	return result;
}
...
CString CDTAcq32::GetBoardList(short index)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x4a, DISPATCH_PROPERTYGET, VT_BSTR, &result, parms,
	             index);
	return result;
}
...
short CDTAcq32::GetQueueSize(short uiQueue)
{
	...
	static BYTE parms[] =
		VTS_I2;
	InvokeHelper(0x4b, DISPATCH_PROPERTYGET, VT_I2, &result, parms,
	             uiQueue);
	return result;
}
