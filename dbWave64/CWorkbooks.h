...
public:
	...
	LPDISPATCH Add(VARIANT& Template)
	{
		...
		InvokeHelper(0xb5, DISPATCH_METHOD, VT_DISPATCH, &result, parms, &Template);
		return result;
	}
	                 ...
	                 VARIANT& Editable, VARIANT& Notify, VARIANT& Converter, VARIANT& AddToMru)
	{
		...
		InvokeHelper(0x2aa, DISPATCH_METHOD, VT_DISPATCH, &result, parms, Filename, &UpdateLinks, &ReadOnly, &Format,
	                ...
	                VARIANT& Other, VARIANT& OtherChar, VARIANT& FieldInfo, VARIANT& TextVisualLayout)
	{
		static BYTE parms[] = VTS_BSTR VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT VTS_VARIANT
			VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
		InvokeHelper(0x2ab, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Filename, &Origin, &StartRow, &DataType,
	               ...
	               VARIANT& DecimalSeparator, VARIANT& ThousandsSeparator)
	{
		...
		InvokeHelper(0x6ed, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Filename, &Origin, &StartRow, &DataType,
		             TextQualifier, &ConsecutiveDelimiter, &tab, &Semicolon, &Comma, &Space, &Other, &OtherChar,
	                ...
	                VARIANT& CorruptLoad)
	{
		...
		static BYTE parms[] = VTS_BSTR VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT
			VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_VARIANT;
		InvokeHelper(0x783, DISPATCH_METHOD, VT_DISPATCH, &result, parms, Filename, &UpdateLinks, &ReadOnly, &Format,
		             &Password, &WriteResPassword, &IgnoreReadOnlyRecommended, &Origin, &Delimiter, &Editable, &Notify,
	              ...
	              VARIANT& DecimalSeparator, VARIANT& ThousandsSeparator, VARIANT& TrailingMinusNumbers, VARIANT& Local)
	{
		static BYTE parms[] = VTS_BSTR VTS_VARIANT VTS_VARIANT VTS_VARIANT VTS_I4 VTS_VARIANT VTS_VARIANT VTS_VARIANT
			...
			VTS_VARIANT;
		InvokeHelper(0x784, DISPATCH_METHOD, VT_EMPTY, nullptr, parms, Filename, &Origin, &StartRow, &DataType,
		             TextQualifier, &ConsecutiveDelimiter, &tab, &Semicolon, &Comma, &Space, &Other, &OtherChar,
	                        ...
	                        VARIANT& ImportDataAs)
	{
		...
		InvokeHelper(0x813, DISPATCH_METHOD, VT_DISPATCH, &result, parms, Filename, &CommandText, &CommandType,
	...
	BOOL CanCheckOut(LPCTSTR Filename)
	{
		BOOL result;
		static BYTE parms[] = VTS_BSTR;
		InvokeHelper(0x816, DISPATCH_METHOD, VT_BOOL, &result, parms, Filename);
		return result;
	}
	...
	LPDISPATCH _OpenXML(LPCTSTR Filename, VARIANT& Stylesheets)
	{
		...
		InvokeHelper(0x817, DISPATCH_METHOD, VT_DISPATCH, &result, parms, Filename, &Stylesheets);
		return result;
	}
	...
	LPDISPATCH OpenXML(LPCTSTR Filename, VARIANT& Stylesheets, VARIANT& LoadOption)
	{
		...
		InvokeHelper(0x8e8, DISPATCH_METHOD, VT_DISPATCH, &result, parms, Filename, &Stylesheets, &LoadOption);
		return result;
	}
