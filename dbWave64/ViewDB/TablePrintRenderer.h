...
public:
	...
	virtual void render_for_export(ViewDbTable* view, CDC* p_dc, const CRect& pixel_rect) = 0;
};
...
public:
	...
	void render_for_export(ViewDbTable* /*view*/, CDC* /*p_dc*/, const CRect& /*pixel_rect*/) override {}
};
